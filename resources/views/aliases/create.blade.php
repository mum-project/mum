...
@section('breadcrumbs')
    @component('layout.components.breadcrumbs')
        @slot('links', ['Aliases' => route('aliases.index'), 'Create'])
    @endcomponent
@endsection
...
@section('content')
    <div class="max-w-lg w-full">
        <div class="dashboard-tile">
            <form class="w-full" action="{{ route('aliases.store') }}" method="POST">
                @csrf
                <h2 class="mb-6 font-extrabold break-words">Create Alias</h2>
